...
export const MatchesList: React.FC<MatchesListProps> = ({
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Users className="h-5 w-5" />Your Travel Buddies</CardTitle>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">Take the quiz and find your travel buddy!</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Users className="h-5 w-5" />Your Travel Buddies ({matches.length})</CardTitle>
      </CardHeader>
        ...
        {matches.map((match) => (
          ...
          >
            <Avatar className="h-12 w-12">
              ...
              <AvatarFallback>{getInitials(match.buddy_profile?.full_name)}</AvatarFallback>
            </Avatar>
